...
## Setup
After installing all dependencies, you need to rename ChromeDriver to **chromedriver_VERSION**, for example the lastest version of chromedriver is v95 so you need to rename chromedriver to `chromedriver_95` and place it in the same folder than the repository.
